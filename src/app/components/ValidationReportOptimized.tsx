...
export function ValidationReportOptimized({
  ...
  const stats = useMemo(() => {
    ...
    const cautionCount = allResults.filter(r => r.status === 'caution').length;
        ...
        <CardHeader className="pb-3 border-b">
          ...
          <div className="flex items-center gap-2 mt-2 text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">
              {stats.dataQuality.adjustedValidRows} / {stats.dataQuality.totalRows}
            </span>
                      ...
                      paginatedRows.map((row, rowIndex) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="border-r border-gray-300 px-3 py-2 bg-gray-50">
                              {auditResults[rowKey] && getAiStatusBadge(auditResults[rowKey])}
                            </td>
