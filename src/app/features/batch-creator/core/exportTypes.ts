...
export type MediaMode = 'keep_public_url' | 'download_and_package' | 'upload_to_storage' | 'custom_lms_reference' | 'base64_inline';
export type MathMode = 'latex' | 'mathml' | 'mathjax';
export type MetadataMode = 'include_all' | 'include_selected' | 'exclude' | 'strict_mapping';
