      ...
      if (ans === undefined || ans === null || String(ans).trim() === "") {
        return [
          createIssue(
            this,
            row.id,
            "Accepted answers cannot be empty strings.",
            "acceptedAnswers",
          ),
        ];
      }
    ...
    if (q.mode === "text" && q.caseSensitive === undefined) {
      return [
        createIssue(
          ...
          [
            {
              id: "set_case_insensitive",
              description: "Set to case-insensitive",
              patch: { "normalizedQuestion.caseSensitive": false },
            },
          ],
        ),
      ];
      ...
      return [
        createIssue(
          ...
          [
            {
              id: "set_trim",
              description: "Enable whitespace trimming",
              patch: { "normalizedQuestion.trimPolicy": "trim" },
            },
          ],
        ),
      ];
