      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-16 pt-20">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="max-w-4xl text-5xl font-semibold tracking-tight leading-[1.1]">
            ...
            <span className="text-primary">PDF-to-QTI engine.</span>
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Tell us about your legacy PDFs, coaching institute workflows, or
            migration requirements. We will point you to the right
            implementation path.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1fr_1.2fr]">
          <div className="rounded-[0.625rem] border border-border bg-card p-8 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              For demos, pricing, and technical questions about OCR ingestion or
              QTI packaging.
            </p>
          ...
          <form className="rounded-[0.625rem] border border-border bg-card p-8 shadow-sm">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex flex-col">
                ...
                <input
                  id="contact-name"
                  className="mt-1.5 h-11 rounded-md border border-border bg-background px-3 text-sm outline-none transition focus:border-primary"
            ...
            <div className="mt-4 flex flex-col">
              ...
              <textarea
                id="contact-message"
                rows={6}
                className="mt-1.5 rounded-md border border-border bg-background px-3 py-2 text-sm outline-none transition focus:border-primary"
                placeholder="Describe your migration or demo request"
              />
            </div>
            <button
              type="button"
              className="mt-5 inline-flex h-11 items-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors"
            >
              Send message
              <ArrowRight className="h-4 w-4" />
            </button>
