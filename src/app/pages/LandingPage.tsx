    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-200">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-12 pt-16">
        ...
        <h1 className="max-w-4xl text-5xl font-semibold tracking-tight leading-[1.1]">
          Turn messy PDFs and images into{" "}
          <span className="text-primary">LMS-ready</span> assessments.
        </h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
          Digitize 10 years of legacy mock tests. Extract complex physics
          diagrams, nested LaTeX equations, and bilingual (English/Regional)
          text into an editable workspace...
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-2">
          ...
          <span className="ml-2 text-xs text-muted-foreground">
            1 free export · no card required
          </span>
        </div>
          ...
          <div className="grid grid-cols-1 gap-16">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                Combine AI-powered LaTeX extraction with human-in-the-loop
                diagram tagging to guarantee 100% flawless LMS imports, no
                matter how chaotic the source PDF is.
              </p>
      ...
      <section className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-10 px-6 py-14 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-muted-foreground">
            Validation and cleaning run on deterministic logic. AI is added only
            for language and quality review, not for fragile parsing.
          </p>
          <div className="mt-6 flex gap-2">
            <Link
              to="/resources"
              className="inline-flex items-center gap-1 rounded-md border border-border bg-card px-3 py-2 text-xs text-foreground hover:bg-muted transition-colors"
            >
            ...
            <Link
              to="/solutions"
              className="inline-flex items-center gap-1 rounded-md px-3 py-2 text-xs text-foreground hover:bg-muted transition-colors"
            >
              Explore solutions
        ...
        <div className="rounded-lg border border-border bg-card p-5 transition-colors duration-200">
          {[
            ...
            <div
              ...
              className="flex items-start gap-2 border-t border-border/50 py-4 first:border-t-0 first:pt-0 last:pb-0"
            >
        ...
        <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <h3 className="mt-2 text-3xl font-semibold tracking-tight text-foreground">
              Need help with your question bank?
            </h3>
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              Share your requirement and our team will get back to you with the
              best way to proceed.
            </p>
          ...
          <form
            ...
            className="rounded-lg border border-border bg-card p-5 shadow-sm transition-colors duration-200"
          >
